classdef Plan < matlab.mixin.Copyable
  ...
  methods
    function obj = Plan(transformParams, targetParams, backendParams, selectParams)
      ...
      % Create the plan
      obj.mData = afft.internal.afft_matlab(uint32(1000), transformParams, targetParams, backendParams, selectParams);
    ...
    function Y = execute(obj, X)
      ...
      Y = afft.internal.afft_matlab(uint32(1001), obj.mData, X);
    end
